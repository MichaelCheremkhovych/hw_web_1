...
class ConsoleUserInterface(UserInterface):
    ...
    def display_commands(self):
        ...
        print("change_name - Change contact's name")
        print("change_phone - Change contact's phone number")
        print("add_birthday - Add contact's birthday")
        print("edit_birthday - Edit contact's birthday")
        print("show_birthday - Show contact's birthday")
        print("upcoming_birthdays - Show upcoming birthdays")
        print("show - Show contact's phone number")
...
def main():
    ...
    address_book = address_book.load_data()
    ...
    while True:
        ...
        if action == "exit" or command == "close":
            ...
            if upcoming:
                ui.display_message("Upcoming birthdays this week:")
                for contact in upcoming:
                    ui.display_message(f"{contact['name']}: {contact['congratulation_date']}")
            else:
                ui.display_message("No upcoming birthdays this week.")    
        elif action == "all":
            ui.display_contacts(address_book.get_all_contacts())
        else:
            ui.display_message("Unknown command.")
            ui.display_commands()
